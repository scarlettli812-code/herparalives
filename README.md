...
移动端优先的轻量人生模拟游戏。当前版本已包含完整的本地 Demo 闭环：游客进入、预设与自定义角色、五章剧情、三选一、因果状态与事件账本、章节 Coach、人生地图、回溯分支、实时章节插图、阶段结局和图鉴。
...
故事生成 V4 的因果模型、生成状态、Wan 插图策略和失败验收矩阵见 [STORY_GENERATION_V4.md](./STORY_GENERATION_V4.md)。
